package com.taehee.portfolio.domain
...
class DataInitializer(
    ...
    fun initializeData(){
        ...
        val c = Skill(name = "C/C++", type = SkillType.LANGUAGE.name, isActive = true)
        ...
        skillRepository.saveAll(mutableListOf(java, kotlin, python, c, spring, django, mysql, redis, kafka))
        ...
        project1.addDetails(
            mutableListOf(
                ProjectDetail(content= "구글맵스를 활용한 유기묘 발견 지역 정보 제공 API 개발", url = null, isActive = true),
                ProjectDetail(content = "Redis를 적용하여 인기 게시글의 조회 속도 1.5초 -> 0.5초로 개선",url = null, isActive = true)
            )
        )
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository", url = "https://github.com/taeheee02", isActive = true)
            )
        )
